  ...
  <dialog id="command_palette" popover>
    ...
    <main>
      ...
      <custom-menu id="menu-commands">
        ...
        <menu-item data-command="activateLightModeTheme">Activer le thème clair</menu-item>
        <menu-item data-command="activateDarkModeTheme">Activer le thème sombre</menu-item>
      </custom-menu>
    </main>
  </dialog>
`
...
const GLOBAL_BINDINGS = [
  ...
  { "command": "activateLightModeTheme", "key": { "ctrlKey": true, "code": "KeyY" } },
  { "command": "activateDarkModeTheme", "key": { "ctrlKey": true, "shiftKey": true, "code": "KeyY" } },
]

const GLOBAL_ACTIONS = [
  { "name": "openCommandPalette", "fun": openCommandPalette },
  { "name": "activateLightModeTheme", "fun": activateLightModeTheme },
  { "name": "activateDarkModeTheme", "fun": activateDarkModeTheme },
]
...
function activateLightModeTheme() {
  document.querySelector('button:has(svg.lucide-sun)').click()
}

function activateDarkModeTheme() {
  document.querySelector('button:has(svg.lucide-moon)').click()
}
